# Getting help with powder

Thanks for using powder. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/powder/issues) to make sure the 
