...
The goal of powder is to create tidy output tables and plots from power and sample size estimations.
...
- `pwr_plot`: create a `ggplot` with input parameters and calculated value (smaple size, power or effect size)
